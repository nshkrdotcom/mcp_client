...
* Iterate inflight requests and reply:
  ...
  ```elixir
  {:error, %Error{type: :shutdown, message: "client shutting down"}}
  ```
...
| :starting      | stop                                |                                     | exit(normal)                                                          | :closing     |
| :starting      | user_call(...)                      |                                     | {:error, %Error{type: :state, data: %{state: :starting}}}            | :starting    |
...
| :initializing  | user_call(...)                      |                                     | {:error, %Error{type: :state, data: %{state: :initializing}}}        | :initializing|
...
| :backoff       | user_call(...)                      |                                     | {:error, %Error{type: :state, data: %{state: :backoff}}}             | :backoff     |
...
* [x] Graceful shutdown: **fail-fast** with `%Error{type: :shutdown}`.
